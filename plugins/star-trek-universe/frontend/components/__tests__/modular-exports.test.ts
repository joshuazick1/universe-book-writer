...
describe('Star Trek Plugin - Modular Component Exports', () => {
    ...
    it('should export LCARS components from base module', async () => {
        const baseModule = await import('../base/index.js');
    ...
    it('should export LCARS interface components from lcars module', async () => {
        const lcarsModule = await import('../lcars/index.js');
    ...
    it('should export Starfleet components from starfleet module', async () => {
        const starfleetModule = await import('../starfleet/index.js');
