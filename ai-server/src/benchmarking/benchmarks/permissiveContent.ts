 ...
 * suiteType: 'gatekeeper' (permissive content is a gatekeeper benchmark)
 * requires: ['content-moderation'] (depends on content moderation)
 */
export const permissiveContentBenchmarkMeta = {
