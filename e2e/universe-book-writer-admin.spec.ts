...
/**
 * VerseForge - Admin Panel Test Suite
 * 
 * This test suite covers the key functionality of the VerseForge application,
...
test.describe('VerseForge - Admin Panel Functionality', () => {
    ...
    async function logoutIfLoggedIn(page) {
        ...
        await expect(page).toHaveTitle('VerseForge');
