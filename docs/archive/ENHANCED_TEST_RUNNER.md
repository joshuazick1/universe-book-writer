...
The enhanced test runner (`scripts/run-tests-with-output.ts`) provides powerful pattern matching and coverage reporting capabilities for the VerseForge project.
