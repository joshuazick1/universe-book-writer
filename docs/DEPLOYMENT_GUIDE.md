...
This guide covers deployment strategies for the Universe Book Writer application across different environments, from local development to production. The application consists of multiple services that can be deployed together or separately.
...
```powershell
# Clone repository
git clone https://github.com/your-org/universe-book-writer.git
...
# Database
MONGODB_URI=mongodb://localhost:27017/universe_book_writer_dev
...
NODE_ENV=production
PORT=5000
FRONTEND_URL=https://app.universebookwriter.com
CORS_ORIGIN=https://app.universebookwriter.com

# Database
MONGODB_URI=mongodb://admin:password@mongodb:27017/universe_book_writer?authSource=admin
...
# Collaboration
WS_PORT=5001
WS_CORS_ORIGIN=https://app.universebookwriter.com

# Email
EMAIL_PROVIDER=smtp
SMTP_HOST=smtp.your-provider.com
SMTP_PORT=587
SMTP_USER=noreply@universebookwriter.com
...
services:
  mongodb:
    ...
    ports:
      - "27017:27017"
    environment:
      MONGO_INITDB_DATABASE: universe_book_writer_dev
    volumes:
...
services:
  ...
  mongodb:
    ...
    environment:
      ...
      MONGO_INITDB_DATABASE: universe_book_writer
    volumes:
...
export const logger = winston.createLogger({
  ...
  defaultMeta: { service: 'universe-book-writer' },
  transports: [
...
server {
    listen 80;
    server_name app.universebookwriter.com;
...
# Obtain certificate
sudo certbot --nginx -d app.universebookwriter.com
